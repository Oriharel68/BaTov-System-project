          ...
          <div class="spec-icons-wrapper">
            <div class="icon-txt-wrapper">
              <img src="https://uploads-ssl.webflow.com/6228bf6850370db453e25ec1/6256e014820e34bab61c415c_Asset%209.svg" loading="lazy" alt="" class="feature-img"/>
                <h2 class="features-txt">סטודיו לשימוש הדיירים</h2>
            </div>
            <div class="icon-txt-wrapper"><img src="https://uploads-ssl.webflow.com/6228bf6850370db453e25ec1/6256e01494238bbde8b7eee7_Asset%205.svg" loading="lazy" alt="" class="feature-img"/>
              <h2 class="features-txt">חלל למידה 
              <br/> שקט</h2>
              </div><div class="icon-txt-wrapper">
                ...
                <h2 class="features-txt">חדרים פרטיים ומאובזרים</h2></div><div class="icon-txt-wrapper">
                  ...
                  <div class="icon-txt-wrapper">
                    ...
                    <h2 class="features-txt">חדר משחקים וטלוויזיה</h2>
                    </div>
                    <div class="icon-txt-wrapper">
              <img src="https://uploads-ssl.webflow.com/6228bf6850370db453e25ec1/6256e0133785c8810e1b6830_Asset%204.svg" loading="lazy" alt="" class="feature-img"/>
                <h2 class="features-txt">חדר מכבסה</h2>
            </div>
            </div>  
            </div>  
