...
<br /><br />
את רוב זמננו עשינו בזום על מנת להצליח בפרוייקט, שיתפנו את חוות דעתנו אחד עם השני , נעזרנו אחד בשני בפתירת תקלות בקוד ,שיתפנו אחד עם השני בקוד , עבדנו בצורה מסדורת ואסטטית מבחינת חלקות משימות, שיתוף קוד בגיט, ותכנון הפרוייקט מבחינה וויזואלית ומבחינה תבניתית -דאטה בייסים,בניית תבניות ותכנון נכון של צד שרת. 
<br /><br />
