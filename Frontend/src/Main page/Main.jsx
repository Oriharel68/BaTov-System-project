...
אנחנו שני סטודנטים בקורס פול סטאק במכללת 
INT 
...
לאחר עבודה קשה ורצון עז הצלחנו ליצור מערכת כמו שתכננו.

השקענו את מלוא זמננו למטרת הפרוייקט ,בגלל המוטיבציה והרצון להצליח.
<br /><br />
את רוב זמננו עשינו בזום על מנת להצליח בפרוייקט, שיתפנו את חוות דעתנו אחד עם השני , נעזרנו אחד בשני בפתירת תקלות בקוד ,שיתפנו אחד עם השני בקוד , עבדנו בצורה מסדורת ואסטטית מבחינת חלוקת משימות, שיתוף קוד GitHub , ותכנון הפרוייקט מבחינה ויזואלית ומבחינה תבניתית - DataBases,בניית תבניות ותכנון נכון של Server-Side. 
<br /><br />
...
אנו מבינים את החשיבות של חוויית המשתמש, ולכן האתר שלנו עוצב להיות אינטואיטיבי ונוח לשימוש. במהלך שלושה לחיצות בלבד, לקוחות יכולים לנווט בין קטגוריות שונות של שירותים, לראות ספקי שירות זמינים ולקבוע את הזמן הרצוי להם.
<br /><br />
עיצובנו המודרני והנקי מבטיח ניווט חלק בכל האתר, ומתמקד בשלבים המרכזיים של תהליך ההזמנה. ממשק המשתמש נוצר בכדי לספק גמישות מרבית והתאמה אישית בעת בחירת השירותים והספקים.
<br /><br />

<ul style={{listStyle:'square'}}>
  <li> <b  className="marker"> הזמנה פשוטה: </b>
 הפלטפורמה שלנו שואפת לפשט משמעותית את תהליך ההזמנה, ולהפטר מטפסים מסובכים והליך מסובך.
</li>
  <li><b  className="marker">זמינות בזמן אמת:</b>
 בדקו את זמינות ספקי השירות בזמן אמת ובחרו את הזמן שמתאים לכם ביותר.
</li>
  <li><b  className="marker">שירותים להתאמה אישית:</b>
 ניתן להתאים אישית את השירות על פי מגוון אפשרויות להתאמה לדרישות הספציפיות.
</li>
  <li><b  className="marker">ממשק נוח למשתמש:</b>
...
<ul style={{listStyle:'square'}}>
  <li><b className="marker">רישום למערכת:</b> 
כדי ליהנות משירותינו, על הלקוחות להירשם לפלטפורמה שלנו.
</li>
  <li><b className="marker">לוח הבקרה האישי ללקוחות:
</b> לאחר ההרשמה, כל לקוח מקבל גישה ללוח הבקרה האישי, המאפשר לו לצפות בהזמנות קודמות, להוסיף חדשות ועוד.
</li>
  <li><b className="marker">ניהול ספקי השירות: 
</b>חברות יכולות להוסיף ספקי שירות חדשים ולראות את ההזמנות בלוח שנה כאירועים. הן יכולות גם לעקוב אחרי כל ההזמנות והרווחים של כל ספק.
</li>
  <li><b className="marker">ניתוח נתונים:
</b> אנו מספקים כלים מתקדמים לניתוח נתונים, המאפשרים לחברות לעקוב אחרי הזמנות והרווחים לאורך הזמן ולקבל החלטות מבוססות נתונים.
</li>
</ul>
        ...
        <div className="wraperTwo-section">
          <div className="introduction-containerFirst">
            <div className="left-container">
              ...
              המשימה שלנו היא לגשר את הפער בין החברות הגדולות שמחפשות ארגון הזמנות עשיר וללקוחות המחפשים חוויית הזמנה פשוטה ויעילה. באמצעות הצעת פלטפורמה המתאימה לשני הצדדים, אנו שואפים לשנות את האופן בו עסקים ולקוחות נפגשים בענף השירותים.

בין שאתם מחפשים התייעצויות מקצועיות, תורים או שירותים אישיים, הפלטפורמה שלנו מחברת אתכם לספקי השירות האמינים. אנחנו מתרגשים להיות הפתרון להזמנות חלקות ולניתוח נתונים חיוניים.

סיירו באתר שלנו כדי לראות את הנוחות שבהזמנת ספקי השירות בצורה חלקה, וגם לגלות את היכולות הניתוחיות החזקות שאנו מספקים.
...
<ul style={{listStyle:'square'}}>
  <li><b className="marker">הרשמה:</b>
 הירשמו לחשבון בפלטפורמה שלנו כדי לגשת לשירותים שלנו.
</li>
  <li><b className="marker">חקרו קטגוריות:</b>
...
<li><b className="marker">בדקו זמינות:</b>
 ...
 בחרו זמן מתאים ואשרו את ההזמנה שלכם.
  ...
  <li><b className="marker">ניהול הזמנות: </b>
לאחר ההזמנה, גשו ללוח הבקרה האישי שלכם כדי לראות ולנהל את ההזמנות שלכם.
</li>
  <li><b className="marker">ספקי השירות:</b> לחברות, הוסיפו ספקי שירות חדשים ונהלו את ההזמנות שלהם ביומן.
</li>
<li><b className="marker">ניתוח נתונים: </b>
