...
{/*  style={{marginTop:'25px',paddingRight:'17px',paddingRight:'0px'}}*/}
         <Link to={'/client/access'}> <button className='button-30' >כניסה</button></Link>
         <Link to={'/client/registration'}><button  className='button-30'  style={{marginTop:'25px'}}>הירשם</button></Link>
          </div>
        </div>
        </div>
