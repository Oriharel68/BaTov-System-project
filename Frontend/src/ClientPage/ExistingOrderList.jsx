      ...
      תאריך : {setDate(order.DateTime)}
       ...
       >
        <div className='Remove-Modal'>
          ...
          <div style={{display:'flex',justifyContent:'space-between',maxWidth:'100%',width:'80%'}}>
            <div style={{cursor:'pointer',display:'flex',flexDirection:'column'}}>
            <BiExit style={{width:'3em',height:'3em'}} onClick={handleClick}>יציאה</BiExit>
            יציאה
            </div>
          
          <div style={{cursor:'pointer',display:'flex',flexDirection:'column'}}>
          <MdRemoveCircleOutline style={{width:'3em',height:'3em'}} onClick={handleRemove}>מחיקה</MdRemoveCircleOutline>
          מחיקה
          </div>
